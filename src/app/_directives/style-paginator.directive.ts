...
export class StylePaginatorDirective {
        ...
        for (let i = 0; i < nodeArray.length; i++) {
          if (nodeArray[i].nodeName === 'BUTTON') {
            if (nodeArray[i].innerHTML.length > 100 && nodeArray[i].disabled) {
              this.ren.setStyle(nodeArray[i], 'background-color', '#93dfd394');
              this.ren.setStyle(nodeArray[i], 'width', '25px');
              this.ren.setStyle(nodeArray[i], 'height', '25px');
              this.ren.setStyle(nodeArray[i], 'line-height', '0px');
              ...
              this.ren.setStyle(nodeArray[i], 'background-color', '#1db8a094');
              this.ren.setStyle(nodeArray[i], 'width', '25px');
              this.ren.setStyle(nodeArray[i], 'height', '25px');
              this.ren.setStyle(nodeArray[i], 'line-height', '0px');
              this.ren.setStyle(nodeArray[i], 'color', 'white');
  ...
  private createButton(i: any, pageIndex: number): any {
    ...
    if (i === pageIndex) {
      ...
      this.ren.setStyle(linkBtn, 'width', '25px');
      this.ren.setStyle(linkBtn, 'height', '25px');
      this.ren.setStyle(linkBtn, 'line-height', '0px');
      this.ren.setStyle(linkBtn, 'padding-top', '10px');
    } else {
