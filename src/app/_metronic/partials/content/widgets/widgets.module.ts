...
import { EngageWidget10Component } from "./engage/engage-widget10/engage-widget10.component";
import { CardsWidget18Component } from "./cards/cards-widget18/cards-widget18.component";
import { NewChartsWidget8Component } from "./charts/new-charts-widget8/new-charts-widget8.component";
import { ListsWidget26Component } from "./lists/lists-widget26/lists-widget26.component";
import { TablesWidget16Component } from "./tables/tables-widget16/tables-widget16.component";

import { ChartsDashboardTotalSalesComponent } from "../../dashboard/chart_totalstales/charts-dashboard-total-order.component";
import { CardDashboardExternalLinksComponent } from "../../dashboard/card-external-links/card-external-linkscomponent";
@NgModule({
  declarations: [
    // Advanced Tables
    ...
    ChartsDashboardTotalSalesComponent,
